...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "CampbellBozorgnia2019",
        "sources": [
            "C:\\RPD\\GitHub\\0_cythonizer\\gmms\\CampbellBozorgnia2019.pyx"
        ]
    },
    "module_name": "CampbellBozorgnia2019"
}
END: Cython Metadata */
...
#define __PYX_HAVE__CampbellBozorgnia2019
#define __PYX_HAVE_API__CampbellBozorgnia2019
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'CampbellBozorgnia2019' */
...
static PyObject *__pyx_f_21CampbellBozorgnia2019_get_phi_cy(int, double, double, double); /*proto*/
static PyObject *__pyx_f_21CampbellBozorgnia2019_get_tau_cy(int, double, double, double); /*proto*/
...
#define __Pyx_MODULE_NAME "CampbellBozorgnia2019"
extern int __pyx_module_is_main_CampbellBozorgnia2019;
int __pyx_module_is_main_CampbellBozorgnia2019 = 0;

/* Implementation of 'CampbellBozorgnia2019' */
...
static const char __pyx_k_Z_tor[] = "Z_tor";
...
static const char __pyx_k_Vs30_R[] = "Vs30_R";
static const char __pyx_k_Z2p5_R[] = "Z2p5_R";
static const char __pyx_k_author[] = "__author__";
static const char __pyx_k_encode[] = "encode";
static const char __pyx_k_format[] = "format";
static const char __pyx_k_fwidth[] = "fwidth";
static const char __pyx_k_import[] = "__import__";
static const char __pyx_k_mu_pga[] = "mu_pga";
...
static const char __pyx_k_CampbellBozorgnia2019[] = "CampbellBozorgnia2019";
...
static const char __pyx_k_CampbellBozorgnia2019_cy[] = "CampbellBozorgnia2019_cy";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_CampbellBozorgnia2019_pyx[] = "CampbellBozorgnia2019.pyx";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static const char __pyx_k_Ground_motion_model_by_Campbell[] = " Ground motion model by Campbell and Bozorgnia (2019) for Ia and CAV . \n";
...
static PyObject *__pyx_n_s_CampbellBozorgnia2019;
static PyObject *__pyx_n_s_CampbellBozorgnia2019_cy;
static PyObject *__pyx_kp_s_CampbellBozorgnia2019_pyx;
...
static PyObject *__pyx_n_s_Vs30_R;
static PyObject *__pyx_n_s_Z2p5;
static PyObject *__pyx_n_s_Z2p5_R;
static PyObject *__pyx_n_s_Z_hyp;
static PyObject *__pyx_n_s_Z_tor;
...
static PyObject *__pyx_n_s_mu_pga;
...
static PyObject *__pyx_pf_21CampbellBozorgnia2019_CampbellBozorgnia2019_cy(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_IM, double __pyx_v_M, double __pyx_v_fwidth, double __pyx_v_fdip, double __pyx_v_Z_tor, double __pyx_v_Z_hyp, __Pyx_memviewslice __pyx_v_R_JB, __Pyx_memviewslice __pyx_v_R_rup, __Pyx_memviewslice __pyx_v_R_x, __Pyx_memviewslice __pyx_v_Vs30, __Pyx_memviewslice __pyx_v_Z2p5, int __pyx_v_fnm, int __pyx_v_frv, PyObject *__pyx_v_region); /* proto */
...
static PyObject *__pyx_f_21CampbellBozorgnia2019_get_phi_cy(int __pyx_v_IM, double __pyx_v_M, double __pyx_v_Vs30, double __pyx_v_A_1100) {
  double __pyx_v_k_1;
  double __pyx_v_k_2;
  double __pyx_v_c;
  double __pyx_v_n;
  ...
  double __pyx_v_rho_2;
  double __pyx_v_phi_lnY;
  double __pyx_v_rho_lnPGA_lnY;
  double __pyx_v_alpha;
  double __pyx_v_phi_lnPGA_B;
  double __pyx_v_phi_lnY_B;
 ...
 *         phi_2    =  0.809
 */
    __pyx_v_phi_lnAF = 0.616;

    /* "CampbellBozorgnia2019.pyx":40
 *         n        =  1.18
 *         phi_lnAF =  0.616
 *         phi_1    =  1.174             # <<<<<<<<<<<<<<
 *         phi_2    =  0.809
 ...
 *     elif M <= 5.5:
 */
    __pyx_v_phi_lnY = (__pyx_v_phi_1 * 1.0);

    /* "CampbellBozorgnia2019.pyx":47
 *     if M <= 4.5:
 *         phi_lnY       = phi_1*1
 *         rho_lnPGA_lnY = rho_1*1             # <<<<<<<<<<<<<<
 *     elif M <= 5.5:
 ...
 */
    __pyx_v_rho_lnPGA_lnY = (__pyx_v_rho_1 * 1.0);
 ...
 *     else:
 */
    __pyx_v_phi_lnY = (__pyx_v_phi_2 + ((__pyx_v_phi_1 - __pyx_v_phi_2) * (5.5 - __pyx_v_M)));

    /* "CampbellBozorgnia2019.pyx":50
 *     elif M <= 5.5:
 *         phi_lnY = phi_2+(phi_1-phi_2)*(5.5-M)
 *         rho_lnPGA_lnY = rho_2+(rho_1-rho_2)*(5.5-M)             # <<<<<<<<<<<<<<
 *     else:
 *         phi_lnY       = phi_2*1
 */
    __pyx_v_rho_lnPGA_lnY = (__pyx_v_rho_2 + ((__pyx_v_rho_1 - __pyx_v_rho_2) * (5.5 - __pyx_v_M)));
 ...
 */
  /*else*/ {
    __pyx_v_phi_lnY = (__pyx_v_phi_2 * 1.0);

    /* "CampbellBozorgnia2019.pyx":53
 *     else:
 *         phi_lnY       = phi_2*1
 *         rho_lnPGA_lnY = rho_2*1             # <<<<<<<<<<<<<<
 *     phi_lnY_B = sqrt(pow(phi_lnY,2)-pow(phi_lnAF,2))
 * 
 */
    __pyx_v_rho_lnPGA_lnY = (__pyx_v_rho_2 * 1.0);
  }
  __pyx_L3:;

  /* "CampbellBozorgnia2019.pyx":54
 *         phi_lnY       = phi_2*1
 *         rho_lnPGA_lnY = rho_2*1
 *     phi_lnY_B = sqrt(pow(phi_lnY,2)-pow(phi_lnAF,2))             # <<<<<<<<<<<<<<
 * 
 *     alpha = 0
 */
  __pyx_v_phi_lnY_B = sqrt((pow(__pyx_v_phi_lnY, 2.0) - pow(__pyx_v_phi_lnAF, 2.0)));

  /* "CampbellBozorgnia2019.pyx":56
 *     phi_lnY_B = sqrt(pow(phi_lnY,2)-pow(phi_lnAF,2))
 * 
 *     alpha = 0             # <<<<<<<<<<<<<<
 *     if Vs30 < k_1:
 ...
 */
    __pyx_v_alpha = ((__pyx_v_k_2 * __pyx_v_A_1100) * (pow((__pyx_v_A_1100 + (__pyx_v_c * pow((__pyx_v_Vs30 / __pyx_v_k_1), __pyx_v_n))), -1.0) - pow((__pyx_v_A_1100 + __pyx_v_c), -1.0)));
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_CampbellBozorgnia2014); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_get_phi_cy); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_M); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
  ...
  __pyx_v_phi_lnPGA_B = __pyx_t_6;

  /* "CampbellBozorgnia2019.pyx":62
 *     phi_lnPGA_B = CampbellBozorgnia2014.get_phi_cy(M)
 * 
 *     return sqrt(pow(phi_lnY_B,2)+pow(phi_lnAF,2)+pow(alpha,2)*pow(phi_lnPGA_B,2)+2*alpha*rho_lnPGA_lnY*phi_lnY_B*phi_lnPGA_B)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = PyFloat_FromDouble(sqrt((((pow(__pyx_v_phi_lnY_B, 2.0) + pow(__pyx_v_phi_lnAF, 2.0)) + (pow(__pyx_v_alpha, 2.0) * pow(__pyx_v_phi_lnPGA_B, 2.0))) + ((((2.0 * __pyx_v_alpha) * __pyx_v_rho_lnPGA_lnY) * __pyx_v_phi_lnY_B) * __pyx_v_phi_lnPGA_B)))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("CampbellBozorgnia2019.get_phi_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_f_21CampbellBozorgnia2019_get_tau_cy(int __pyx_v_IM, double __pyx_v_M, double __pyx_v_Vs30, double __pyx_v_A_1100) {
  double __pyx_v_k_1;
  double __pyx_v_k_2;
  double __pyx_v_c;
  double __pyx_v_n;
 ...
 *     elif M <= 5.5:
 */
    __pyx_v_tau_lnY = (__pyx_v_tau_1 * 1.0);

    /* "CampbellBozorgnia2019.pyx":97
 *     if M <= 4.5:
 *         tau_lnY       = tau_1*1
 *         rho_lnPGA_lnY = rho_1*1             # <<<<<<<<<<<<<<
 *     elif M <= 5.5:
 ...
 *     else:
 */
    __pyx_v_tau_lnY = (__pyx_v_tau_2 + ((__pyx_v_tau_1 - __pyx_v_tau_2) * (5.5 - __pyx_v_M)));

    /* "CampbellBozorgnia2019.pyx":100
 *     elif M <= 5.5:
 *         tau_lnY       = tau_2+(tau_1-tau_2)*(5.5-M)
 *         rho_lnPGA_lnY = rho_2+(rho_1-rho_2)*(5.5-M)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  /*else*/ {
    __pyx_v_tau_lnY = (__pyx_v_tau_2 * 1.0);

    /* "CampbellBozorgnia2019.pyx":103
 *     else:
 *         tau_lnY       = tau_2*1
 *         rho_lnPGA_lnY = rho_2*1             # <<<<<<<<<<<<<<
 *     tau_lnY_B = tau_lnY*1
 ...
 *     alpha = 0
 */
  __pyx_v_tau_lnY_B = (__pyx_v_tau_lnY * 1.0);

  /* "CampbellBozorgnia2019.pyx":106
 *     tau_lnY_B = tau_lnY*1
 * 
 *     alpha = 0             # <<<<<<<<<<<<<<
 *     if Vs30 < k_1:
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_CampbellBozorgnia2014); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 110, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_get_tau_cy); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 110, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_M); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 110, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_4))) {
    __pyx_t_5 = PyMethod_GET_SELF(__pyx_t_4);
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_tau_lnPGA_B = __pyx_t_6;

  /* "CampbellBozorgnia2019.pyx":112
 *     tau_lnPGA_B = CampbellBozorgnia2014.get_tau_cy(M)
 * 
 *     return sqrt(pow(tau_lnY_B,2)+pow(alpha,2)*pow(tau_lnPGA_B,2)+2*alpha*rho_lnPGA_lnY*tau_lnY_B*tau_lnPGA_B)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyFloat_FromDouble(sqrt(((pow(__pyx_v_tau_lnY_B, 2.0) + (pow(__pyx_v_alpha, 2.0) * pow(__pyx_v_tau_lnPGA_B, 2.0))) + ((((2.0 * __pyx_v_alpha) * __pyx_v_rho_lnPGA_lnY) * __pyx_v_tau_lnY_B) * __pyx_v_tau_lnPGA_B)))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_AddTraceback("CampbellBozorgnia2019.get_tau_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_21CampbellBozorgnia2019_1CampbellBozorgnia2019_cy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_21CampbellBozorgnia2019_CampbellBozorgnia2019_cy[] = "\n    Parameter\n    =========\n    IM: 0 for Ia, and 1 for CAV.\n    M: Earthquake magnitude.\n    fwidth: Fault width in km.\n    fdip: Fault dip in deg.\n    Z_hyp: Hypocentral depth in km.\n    Z_tor: Depth to top of fault rupture in km.\n    R_JB: Joyner-Boore distance in km.\n    R_rup: Rupture distance in km.\n    R_x: Rx distance in km.\n    Vs30: Site Vs30. \n    Z2p5: Depth to Vs = 2.5 km/s.\n    fnm: 1 for normal/normal-oblique fault, 0 otherwise.\n    frv: 1 for reverse/reverse-oblique fault, 0 otherwise.\n    region: Earthquake country.\n\n    Returns\n    =======\n    mean, phi, tau for the selected IM.\n    ";
static PyMethodDef __pyx_mdef_21CampbellBozorgnia2019_1CampbellBozorgnia2019_cy = {"CampbellBozorgnia2019_cy", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_21CampbellBozorgnia2019_1CampbellBozorgnia2019_cy, METH_VARARGS|METH_KEYWORDS, __pyx_doc_21CampbellBozorgnia2019_CampbellBozorgnia2019_cy};
static PyObject *__pyx_pw_21CampbellBozorgnia2019_1CampbellBozorgnia2019_cy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_IM;
  double __pyx_v_M;
  double __pyx_v_fwidth;
  double __pyx_v_fdip;
  double __pyx_v_Z_tor;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("CampbellBozorgnia2019_cy (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_IM,&__pyx_n_s_M,&__pyx_n_s_fwidth,&__pyx_n_s_fdip,&__pyx_n_s_Z_tor,&__pyx_n_s_Z_hyp,&__pyx_n_s_R_JB,&__pyx_n_s_R_rup,&__pyx_n_s_R_x,&__pyx_n_s_Vs30,&__pyx_n_s_Z2p5,&__pyx_n_s_fnm,&__pyx_n_s_frv,&__pyx_n_s_region,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_M)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 1); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fwidth)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 2); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fdip)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 3); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Z_tor)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 4); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Z_hyp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 5); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_R_JB)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 6); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_R_rup)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 7); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_R_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 8); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Vs30)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 9); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Z2p5)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 10); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fnm)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 11); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_frv)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 12); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 13:
        if (likely((values[13] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_region)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, 13); __PYX_ERR(0, 121, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "CampbellBozorgnia2019_cy") < 0)) __PYX_ERR(0, 121, __pyx_L3_error)
      }
    ...
    __pyx_v_IM = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_IM == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_M = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_M == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_fwidth = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_fwidth == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_fdip = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_fdip == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_Z_tor = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_Z_tor == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_Z_hyp = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_Z_hyp == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_R_JB = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_R_JB.memview)) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_R_rup = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_R_rup.memview)) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_R_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_R_x.memview)) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_Vs30 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[9], PyBUF_WRITABLE); if (unlikely(!__pyx_v_Vs30.memview)) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_Z2p5 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[10], PyBUF_WRITABLE); if (unlikely(!__pyx_v_Z2p5.memview)) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_fnm = __Pyx_PyInt_As_int(values[11]); if (unlikely((__pyx_v_fnm == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 123, __pyx_L3_error)
    __pyx_v_frv = __Pyx_PyInt_As_int(values[12]); if (unlikely((__pyx_v_frv == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 123, __pyx_L3_error)
    __pyx_v_region = values[13];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("CampbellBozorgnia2019_cy", 1, 14, 14, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 121, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("CampbellBozorgnia2019.CampbellBozorgnia2019_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21CampbellBozorgnia2019_CampbellBozorgnia2019_cy(__pyx_self, __pyx_v_IM, __pyx_v_M, __pyx_v_fwidth, __pyx_v_fdip, __pyx_v_Z_tor, __pyx_v_Z_hyp, __pyx_v_R_JB, __pyx_v_R_rup, __pyx_v_R_x, __pyx_v_Vs30, __pyx_v_Z2p5, __pyx_v_fnm, __pyx_v_frv, __pyx_v_region);
...
static PyObject *__pyx_pf_21CampbellBozorgnia2019_CampbellBozorgnia2019_cy(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_IM, double __pyx_v_M, double __pyx_v_fwidth, double __pyx_v_fdip, double __pyx_v_Z_tor, double __pyx_v_Z_hyp, __Pyx_memviewslice __pyx_v_R_JB, __Pyx_memviewslice __pyx_v_R_rup, __Pyx_memviewslice __pyx_v_R_x, __Pyx_memviewslice __pyx_v_Vs30, __Pyx_memviewslice __pyx_v_Z2p5, int __pyx_v_fnm, int __pyx_v_frv, PyObject *__pyx_v_region) {
  int __pyx_v_N_sites;
  double __pyx_v_Vs30_R;
  double __pyx_v_Z2p5_R;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("CampbellBozorgnia2019_cy", 0);

  /* "CampbellBozorgnia2019.pyx":148
 *     """
 * 
 ...
 */
  __pyx_v_Z2p5_R = exp((7.089 - (1.144 * log(1100.))));

  /* "CampbellBozorgnia2019.pyx":151
 *     cdef double Vs30_R = 1100.
 *     cdef double Z2p5_R = exp(7.089-1.144*log(1100.))
 *     cdef double[:] mu_im  = np.zeros(N_sites, dtype='float64')             # <<<<<<<<<<<<<<
 *     cdef double[:] phi_im = np.zeros(N_sites, dtype='float64')
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_N_sites); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 151, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_n_u_float64) < 0) __PYX_ERR(0, 151, __pyx_L1_error)
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 151, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 151, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_mu_im = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "CampbellBozorgnia2019.pyx":152
 *     cdef double Z2p5_R = exp(7.089-1.144*log(1100.))
 *     cdef double[:] mu_im  = np.zeros(N_sites, dtype='float64')
 *     cdef double[:] phi_im = np.zeros(N_sites, dtype='float64')             # <<<<<<<<<<<<<<
 *     cdef double[:] tau_im = np.zeros(N_sites, dtype='float64')
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 152, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_N_sites); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 152, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_n_u_float64) < 0) __PYX_ERR(0, 152, __pyx_L1_error)
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 152, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 152, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_phi_im = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "CampbellBozorgnia2019.pyx":153
 *     cdef double[:] mu_im  = np.zeros(N_sites, dtype='float64')
 *     cdef double[:] phi_im = np.zeros(N_sites, dtype='float64')
 *     cdef double[:] tau_im = np.zeros(N_sites, dtype='float64')             # <<<<<<<<<<<<<<
 *     cdef double mu_pga
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_N_sites); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 153, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_n_u_float64) < 0) __PYX_ERR(0, 153, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 153, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 153, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_tau_im = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "CampbellBozorgnia2019.pyx":157
 *     cdef int i
 * 
 ...
 */
    __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_CampbellBozorgnia2014); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_get_mu_cy); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyFloat_FromDouble(__pyx_v_M); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = PyFloat_FromDouble(__pyx_v_fwidth); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_10 = PyFloat_FromDouble(__pyx_v_fdip); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_11 = PyFloat_FromDouble(__pyx_v_Z_tor); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __pyx_t_12 = PyFloat_FromDouble(__pyx_v_Z_hyp); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_14 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_R_JB.data + __pyx_t_13 * __pyx_v_R_JB.strides[0]) )))); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_15 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_R_rup.data + __pyx_t_13 * __pyx_v_R_rup.strides[0]) )))); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_16 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_R_x.data + __pyx_t_13 * __pyx_v_R_x.strides[0]) )))); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __pyx_t_17 = PyFloat_FromDouble(__pyx_v_Vs30_R); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_17);
    __pyx_t_18 = PyFloat_FromDouble(__pyx_v_Z2p5_R); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_18);
    __pyx_t_19 = __Pyx_PyInt_From_int(__pyx_v_fnm); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_19);
    __pyx_t_20 = __Pyx_PyInt_From_int(__pyx_v_frv); if (unlikely(!__pyx_t_20)) __PYX_ERR(0, 158, __pyx_L1_error)
    ...
    if (PyFunction_Check(__pyx_t_4)) {
      PyObject *__pyx_temp[16] = {__pyx_t_21, __pyx_int_2, __pyx_t_3, __pyx_t_5, __pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_float_0_, __pyx_t_19, __pyx_t_20, __pyx_v_region};
      __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_22, 15+__pyx_t_22); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 158, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_4)) {
      PyObject *__pyx_temp[16] = {__pyx_t_21, __pyx_int_2, __pyx_t_3, __pyx_t_5, __pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_float_0_, __pyx_t_19, __pyx_t_20, __pyx_v_region};
      __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_22, 15+__pyx_t_22); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 158, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_21); __pyx_t_21 = 0;
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    #endif
    {
      __pyx_t_23 = PyTuple_New(15+__pyx_t_22); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 158, __pyx_L1_error)
      ...
      PyTuple_SET_ITEM(__pyx_t_23, 0+__pyx_t_22, __pyx_int_2);
      __Pyx_GIVEREF(__pyx_t_3);
      PyTuple_SET_ITEM(__pyx_t_23, 1+__pyx_t_22, __pyx_t_3);
      __Pyx_GIVEREF(__pyx_t_5);
      PyTuple_SET_ITEM(__pyx_t_23, 2+__pyx_t_22, __pyx_t_5);
      __Pyx_GIVEREF(__pyx_t_10);
      PyTuple_SET_ITEM(__pyx_t_23, 3+__pyx_t_22, __pyx_t_10);
      __Pyx_GIVEREF(__pyx_t_11);
      PyTuple_SET_ITEM(__pyx_t_23, 4+__pyx_t_22, __pyx_t_11);
      __Pyx_GIVEREF(__pyx_t_12);
      PyTuple_SET_ITEM(__pyx_t_23, 5+__pyx_t_22, __pyx_t_12);
      __Pyx_GIVEREF(__pyx_t_14);
      PyTuple_SET_ITEM(__pyx_t_23, 6+__pyx_t_22, __pyx_t_14);
      __Pyx_GIVEREF(__pyx_t_15);
      PyTuple_SET_ITEM(__pyx_t_23, 7+__pyx_t_22, __pyx_t_15);
      __Pyx_GIVEREF(__pyx_t_16);
      PyTuple_SET_ITEM(__pyx_t_23, 8+__pyx_t_22, __pyx_t_16);
      __Pyx_GIVEREF(__pyx_t_17);
      PyTuple_SET_ITEM(__pyx_t_23, 9+__pyx_t_22, __pyx_t_17);
      __Pyx_GIVEREF(__pyx_t_18);
      PyTuple_SET_ITEM(__pyx_t_23, 10+__pyx_t_22, __pyx_t_18);
      __Pyx_INCREF(__pyx_float_0_);
      __Pyx_GIVEREF(__pyx_float_0_);
      PyTuple_SET_ITEM(__pyx_t_23, 11+__pyx_t_22, __pyx_float_0_);
      __Pyx_GIVEREF(__pyx_t_19);
      PyTuple_SET_ITEM(__pyx_t_23, 12+__pyx_t_22, __pyx_t_19);
      __Pyx_GIVEREF(__pyx_t_20);
      PyTuple_SET_ITEM(__pyx_t_23, 13+__pyx_t_22, __pyx_t_20);
      __Pyx_INCREF(__pyx_v_region);
      __Pyx_GIVEREF(__pyx_v_region);
      PyTuple_SET_ITEM(__pyx_t_23, 14+__pyx_t_22, __pyx_v_region);
      __pyx_t_3 = 0;
      __pyx_t_5 = 0;
      __pyx_t_10 = 0;
      __pyx_t_11 = 0;
      ...
      __pyx_t_19 = 0;
      __pyx_t_20 = 0;
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_23, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 158, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    }
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_24 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_24 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_v_mu_pga = __pyx_t_24;

    /* "CampbellBozorgnia2019.pyx":159
 *     for i in range(N_sites):
 *         mu_pga = CampbellBozorgnia2014.get_mu_cy(2,M,fwidth,fdip,Z_tor,Z_hyp,R_JB[i],R_rup[i],R_x[i],Vs30_R,Z2p5_R,0.,fnm,frv,region)
 *         mu_im[i]  = CampbellBozorgnia2014.get_mu_cy(IM,M,fwidth,fdip,Z_tor,Z_hyp,R_JB[i],R_rup[i],R_x[i],Vs30[i],Z2p5[i],exp(mu_pga),fnm,frv,region)             # <<<<<<<<<<<<<<
 *         phi_im[i] = get_phi_cy(IM,M,Vs30[i],exp(mu_pga))
 ...
 */
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_CampbellBozorgnia2014); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_23 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_get_mu_cy); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_23);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_IM); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_20 = PyFloat_FromDouble(__pyx_v_M); if (unlikely(!__pyx_t_20)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_20);
    __pyx_t_19 = PyFloat_FromDouble(__pyx_v_fwidth); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_19);
    __pyx_t_18 = PyFloat_FromDouble(__pyx_v_fdip); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_18);
    __pyx_t_17 = PyFloat_FromDouble(__pyx_v_Z_tor); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_17);
    __pyx_t_16 = PyFloat_FromDouble(__pyx_v_Z_hyp); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_15 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_R_JB.data + __pyx_t_13 * __pyx_v_R_JB.strides[0]) )))); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_14 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_R_rup.data + __pyx_t_13 * __pyx_v_R_rup.strides[0]) )))); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_12 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_R_x.data + __pyx_t_13 * __pyx_v_R_x.strides[0]) )))); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_11 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_Vs30.data + __pyx_t_13 * __pyx_v_Vs30.strides[0]) )))); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_10 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_Z2p5.data + __pyx_t_13 * __pyx_v_Z2p5.strides[0]) )))); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_5 = PyFloat_FromDouble(exp(__pyx_v_mu_pga)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_fnm); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_21 = __Pyx_PyInt_From_int(__pyx_v_frv); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 159, __pyx_L1_error)
    ...
    if (PyFunction_Check(__pyx_t_23)) {
      PyObject *__pyx_temp[16] = {__pyx_t_25, __pyx_t_4, __pyx_t_20, __pyx_t_19, __pyx_t_18, __pyx_t_17, __pyx_t_16, __pyx_t_15, __pyx_t_14, __pyx_t_12, __pyx_t_11, __pyx_t_10, __pyx_t_5, __pyx_t_3, __pyx_t_21, __pyx_v_region};
      __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_23, __pyx_temp+1-__pyx_t_22, 15+__pyx_t_22); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 159, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_23)) {
      PyObject *__pyx_temp[16] = {__pyx_t_25, __pyx_t_4, __pyx_t_20, __pyx_t_19, __pyx_t_18, __pyx_t_17, __pyx_t_16, __pyx_t_15, __pyx_t_14, __pyx_t_12, __pyx_t_11, __pyx_t_10, __pyx_t_5, __pyx_t_3, __pyx_t_21, __pyx_v_region};
      __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_23, __pyx_temp+1-__pyx_t_22, 15+__pyx_t_22); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 159, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_25); __pyx_t_25 = 0;
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_20); __pyx_t_20 = 0;
    ...
    #endif
    {
      __pyx_t_26 = PyTuple_New(15+__pyx_t_22); if (unlikely(!__pyx_t_26)) __PYX_ERR(0, 159, __pyx_L1_error)
      ...
      __Pyx_GIVEREF(__pyx_t_20);
      PyTuple_SET_ITEM(__pyx_t_26, 1+__pyx_t_22, __pyx_t_20);
      __Pyx_GIVEREF(__pyx_t_19);
      PyTuple_SET_ITEM(__pyx_t_26, 2+__pyx_t_22, __pyx_t_19);
      __Pyx_GIVEREF(__pyx_t_18);
      PyTuple_SET_ITEM(__pyx_t_26, 3+__pyx_t_22, __pyx_t_18);
      __Pyx_GIVEREF(__pyx_t_17);
      PyTuple_SET_ITEM(__pyx_t_26, 4+__pyx_t_22, __pyx_t_17);
      __Pyx_GIVEREF(__pyx_t_16);
      PyTuple_SET_ITEM(__pyx_t_26, 5+__pyx_t_22, __pyx_t_16);
      __Pyx_GIVEREF(__pyx_t_15);
      PyTuple_SET_ITEM(__pyx_t_26, 6+__pyx_t_22, __pyx_t_15);
      __Pyx_GIVEREF(__pyx_t_14);
      PyTuple_SET_ITEM(__pyx_t_26, 7+__pyx_t_22, __pyx_t_14);
      __Pyx_GIVEREF(__pyx_t_12);
      PyTuple_SET_ITEM(__pyx_t_26, 8+__pyx_t_22, __pyx_t_12);
      __Pyx_GIVEREF(__pyx_t_11);
      PyTuple_SET_ITEM(__pyx_t_26, 9+__pyx_t_22, __pyx_t_11);
      __Pyx_GIVEREF(__pyx_t_10);
      PyTuple_SET_ITEM(__pyx_t_26, 10+__pyx_t_22, __pyx_t_10);
      __Pyx_GIVEREF(__pyx_t_5);
      PyTuple_SET_ITEM(__pyx_t_26, 11+__pyx_t_22, __pyx_t_5);
      __Pyx_GIVEREF(__pyx_t_3);
      PyTuple_SET_ITEM(__pyx_t_26, 12+__pyx_t_22, __pyx_t_3);
      __Pyx_GIVEREF(__pyx_t_21);
      PyTuple_SET_ITEM(__pyx_t_26, 13+__pyx_t_22, __pyx_t_21);
      __Pyx_INCREF(__pyx_v_region);
      __Pyx_GIVEREF(__pyx_v_region);
      PyTuple_SET_ITEM(__pyx_t_26, 14+__pyx_t_22, __pyx_v_region);
      __pyx_t_4 = 0;
      __pyx_t_20 = 0;
      __pyx_t_19 = 0;
      __pyx_t_18 = 0;
      ...
      __pyx_t_3 = 0;
      __pyx_t_21 = 0;
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_23, __pyx_t_26, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 159, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_26); __pyx_t_26 = 0;
    }
    __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    __pyx_t_24 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_24 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 159, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_13 = __pyx_v_i;
    *((double *) ( /* dim=0 */ (__pyx_v_mu_im.data + __pyx_t_13 * __pyx_v_mu_im.strides[0]) )) = __pyx_t_24;

    /* "CampbellBozorgnia2019.pyx":160
 *         mu_pga = CampbellBozorgnia2014.get_mu_cy(2,M,fwidth,fdip,Z_tor,Z_hyp,R_JB[i],R_rup[i],R_x[i],Vs30_R,Z2p5_R,0.,fnm,frv,region)
 *         mu_im[i]  = CampbellBozorgnia2014.get_mu_cy(IM,M,fwidth,fdip,Z_tor,Z_hyp,R_JB[i],R_rup[i],R_x[i],Vs30[i],Z2p5[i],exp(mu_pga),fnm,frv,region)
 *         phi_im[i] = get_phi_cy(IM,M,Vs30[i],exp(mu_pga))             # <<<<<<<<<<<<<<
 *         tau_im[i] = get_tau_cy(IM,M,Vs30[i],exp(mu_pga))
 ...
 */
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_2 = __pyx_f_21CampbellBozorgnia2019_get_phi_cy(__pyx_v_IM, __pyx_v_M, (*((double *) ( /* dim=0 */ (__pyx_v_Vs30.data + __pyx_t_13 * __pyx_v_Vs30.strides[0]) ))), exp(__pyx_v_mu_pga)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 160, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_24 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_24 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 160, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_13 = __pyx_v_i;
    *((double *) ( /* dim=0 */ (__pyx_v_phi_im.data + __pyx_t_13 * __pyx_v_phi_im.strides[0]) )) = __pyx_t_24;

    /* "CampbellBozorgnia2019.pyx":161
 *         mu_im[i]  = CampbellBozorgnia2014.get_mu_cy(IM,M,fwidth,fdip,Z_tor,Z_hyp,R_JB[i],R_rup[i],R_x[i],Vs30[i],Z2p5[i],exp(mu_pga),fnm,frv,region)
 *         phi_im[i] = get_phi_cy(IM,M,Vs30[i],exp(mu_pga))
 *         tau_im[i] = get_tau_cy(IM,M,Vs30[i],exp(mu_pga))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_2 = __pyx_f_21CampbellBozorgnia2019_get_tau_cy(__pyx_v_IM, __pyx_v_M, (*((double *) ( /* dim=0 */ (__pyx_v_Vs30.data + __pyx_t_13 * __pyx_v_Vs30.strides[0]) ))), exp(__pyx_v_mu_pga)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 161, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_24 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_24 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 161, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_13 = __pyx_v_i;
    *((double *) ( /* dim=0 */ (__pyx_v_tau_im.data + __pyx_t_13 * __pyx_v_tau_im.strides[0]) )) = __pyx_t_24;
  }

  /* "CampbellBozorgnia2019.pyx":163
 *         tau_im[i] = get_tau_cy(IM,M,Vs30[i],exp(mu_pga))
 * 
 *     return np.asarray(mu_im),np.asarray(phi_im),np.asarray(tau_im)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __Pyx_GetModuleGlobalName(__pyx_t_23, __pyx_n_s_np); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_26 = __Pyx_PyObject_GetAttrStr(__pyx_t_23, __pyx_n_s_asarray); if (unlikely(!__pyx_t_26)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_26);
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  __pyx_t_23 = __pyx_memoryview_fromslice(__pyx_v_mu_im, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_21 = NULL;
  ...
  __pyx_t_2 = (__pyx_t_21) ? __Pyx_PyObject_Call2Args(__pyx_t_26, __pyx_t_21, __pyx_t_23) : __Pyx_PyObject_CallOneArg(__pyx_t_26, __pyx_t_23);
  __Pyx_XDECREF(__pyx_t_21); __pyx_t_21 = 0;
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_23, __pyx_n_s_np); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_21 = __Pyx_PyObject_GetAttrStr(__pyx_t_23, __pyx_n_s_asarray); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_21);
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  __pyx_t_23 = __pyx_memoryview_fromslice(__pyx_v_phi_im, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_3 = NULL;
  ...
  __pyx_t_26 = (__pyx_t_3) ? __Pyx_PyObject_Call2Args(__pyx_t_21, __pyx_t_3, __pyx_t_23) : __Pyx_PyObject_CallOneArg(__pyx_t_21, __pyx_t_23);
  __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  if (unlikely(!__pyx_t_26)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_26);
  __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  __Pyx_GetModuleGlobalName(__pyx_t_23, __pyx_n_s_np); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_23, __pyx_n_s_asarray); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  __pyx_t_23 = __pyx_memoryview_fromslice(__pyx_v_tau_im, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 163, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_5 = NULL;
  ...
  __pyx_t_21 = (__pyx_t_5) ? __Pyx_PyObject_Call2Args(__pyx_t_3, __pyx_t_5, __pyx_t_23) : __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_23);
  __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "CampbellBozorgnia2019.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "CampbellBozorgnia2019.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "CampbellBozorgnia2019.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "CampbellBozorgnia2019._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_CampbellBozorgnia2019(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_CampbellBozorgnia2019},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_CampbellBozorgnia2019, __pyx_k_CampbellBozorgnia2019, sizeof(__pyx_k_CampbellBozorgnia2019), 0, 0, 1, 1},
  {&__pyx_n_s_CampbellBozorgnia2019_cy, __pyx_k_CampbellBozorgnia2019_cy, sizeof(__pyx_k_CampbellBozorgnia2019_cy), 0, 0, 1, 1},
  {&__pyx_kp_s_CampbellBozorgnia2019_pyx, __pyx_k_CampbellBozorgnia2019_pyx, sizeof(__pyx_k_CampbellBozorgnia2019_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_Vs30_R, __pyx_k_Vs30_R, sizeof(__pyx_k_Vs30_R), 0, 0, 1, 1},
  {&__pyx_n_s_Z2p5, __pyx_k_Z2p5, sizeof(__pyx_k_Z2p5), 0, 0, 1, 1},
  {&__pyx_n_s_Z2p5_R, __pyx_k_Z2p5_R, sizeof(__pyx_k_Z2p5_R), 0, 0, 1, 1},
  {&__pyx_n_s_Z_hyp, __pyx_k_Z_hyp, sizeof(__pyx_k_Z_hyp), 0, 0, 1, 1},
  {&__pyx_n_s_Z_tor, __pyx_k_Z_tor, sizeof(__pyx_k_Z_tor), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_mu_pga, __pyx_k_mu_pga, sizeof(__pyx_k_mu_pga), 0, 0, 1, 1},
 ...
 *                              int fnm,int frv,region):
 */
  __pyx_tuple__22 = PyTuple_Pack(22, __pyx_n_s_IM, __pyx_n_s_M, __pyx_n_s_fwidth, __pyx_n_s_fdip, __pyx_n_s_Z_tor, __pyx_n_s_Z_hyp, __pyx_n_s_R_JB, __pyx_n_s_R_rup, __pyx_n_s_R_x, __pyx_n_s_Vs30, __pyx_n_s_Z2p5, __pyx_n_s_fnm, __pyx_n_s_frv, __pyx_n_s_region, __pyx_n_s_N_sites, __pyx_n_s_Vs30_R, __pyx_n_s_Z2p5_R, __pyx_n_s_mu_im, __pyx_n_s_phi_im, __pyx_n_s_tau_im, __pyx_n_s_mu_pga, __pyx_n_s_i); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(14, 0, 22, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_CampbellBozorgnia2019_pyx, __pyx_n_s_CampbellBozorgnia2019_cy, 121, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 121, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initCampbellBozorgnia2019(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initCampbellBozorgnia2019(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_CampbellBozorgnia2019(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_CampbellBozorgnia2019(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_CampbellBozorgnia2019(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'CampbellBozorgnia2019' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_CampbellBozorgnia2019(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("CampbellBozorgnia2019", __pyx_methods, __pyx_k_Ground_motion_model_by_Campbell, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_CampbellBozorgnia2019) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "CampbellBozorgnia2019")) {
      if (unlikely(PyDict_SetItemString(modules, "CampbellBozorgnia2019", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_CampbellBozorgnia2014, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_CampbellBozorgnia2014, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "CampbellBozorgnia2019.pyx":10
 * from libc.math cimport pi, cos, pow, sqrt, exp, fmax, log
 * 
 ...
 *                              int fnm,int frv,region):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_21CampbellBozorgnia2019_1CampbellBozorgnia2019_cy, NULL, __pyx_n_s_CampbellBozorgnia2019); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_CampbellBozorgnia2019_cy, __pyx_t_1) < 0) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "CampbellBozorgnia2019.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init CampbellBozorgnia2019", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init CampbellBozorgnia2019");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
